export default function AboutUs() {
  return (
    <section
      id="about"
      className="reveal-section relative z-10 mt-8 w-full bg-white px-4 pt-12 pb-20 transition-colors duration-300 dark:bg-black sm:px-6 md:mt-0 md:pb-24"
    >
      <div className="mx-auto max-w-5xl">
        <div className="grid items-center gap-10 md:grid-cols-2 md:gap-12">
          <div className="group order-2 flex w-full justify-center md:order-1">
            ...
            <div className="order-1 space-y-5 text-base text-gray-600 dark:text-gray-400 sm:text-lg md:order-2 md:space-y-6">
                <h2 className="mb-6 text-center text-3xl font-bold tracking-tight text-gray-800 dark:text-gray-300 md:mb-12 md:text-left md:text-4xl">¿Quiénes Somos?</h2>
